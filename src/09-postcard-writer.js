...
export function writePostcard(sender, receiver, message) {
  if(typeof message!=="string" || message.trim()==="" || typeof sender!=="string" || sender.trim()==="" || typeof receiver!=="string" || receiver.trim()==="") return "";
...
export function countVowels(message) {
 if(typeof message!=="string") return 0;
  const mess=message.match(/[aeiouAEIOU]/g);
  return mess?mess.length:0;
}
